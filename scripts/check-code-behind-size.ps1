...
$limits = [ordered]@{
    ...
    # 監視対象選択、Recent activity のログ行保持、Recent review events の一覧保持・処理順序、レビュー登録結果の分類、Gateway URL / Resource URI 入力フロー、Gateway login lifecycle、実行ウィンドウ lifecycle を Coordinator へ移した。WinUI 固有のウィンドウ adapter は code-behind 側へ戻したため、実測値を 1381 行へ更新する。
    "winui3/SquirrelNotifier.WinUI3/MainWindow.xaml.cs"              = 1381
