...
$limits = [ordered]@{
    # #286 の URL・ログフォルダー起動・ウィンドウアイコン・Clipboard・購読状態表示・トレイコマンド・終了処理の抽出を反映。
    # 終了時のイベント解除を明示する UI 配線を追加したため、実測値を 1531 行へ更新する。
    "winui3/SquirrelNotifier.WinUI3/MainWindow.xaml.cs"              = 1531
