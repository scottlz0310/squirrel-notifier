...
$limits = [ordered]@{
    # #286 の URL・ログフォルダー起動・ウィンドウアイコン・Clipboard・購読状態表示・トレイコマンド・終了処理・通知予約切替の抽出を反映。
    # 通知予約切替の分岐と状態同期を Coordinator へ移したため、実測値を 1524 行へ更新する。
    "winui3/SquirrelNotifier.WinUI3/MainWindow.xaml.cs"              = 1524
