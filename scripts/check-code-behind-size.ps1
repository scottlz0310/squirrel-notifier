...
$limits = [ordered]@{
    ...
    # 監視対象選択、Recent activity のログ行保持、Recent review events の一覧保持・処理順序、レビュー登録結果の分類、Gateway URL / Resource URI 入力フロー、Gateway login lifecycle、実行ウィンドウ lifecycle、レビュー通知の表示経路を Coordinator へ移した。WinUI 固有の表示アダプターは code-behind 側に残している。
    "winui3/SquirrelNotifier.WinUI3/MainWindow.xaml.cs"              = 1358
